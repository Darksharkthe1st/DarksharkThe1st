...
- 🤖 **AI Engineer** at Testudo Agentic AI - Building autonomous LLM agent systems with self-correcting feedback, tool registries, and RESTful Flask APIs
- 🔬 **AI Research** - Developed activation steering pipelines for LLM bias reduction, improving BBQ neutrality by 60% (Algoverse Research)
- ☁️ **AWS Certification** - AWS Certified Cloud Practitioner (January 2026)
...
### [Rent-Swarm](https://github.com/optimusbuilder/Rent-Swarm) | 🏆 Hack@Brown 2-Track Winner ($2K+)
...
**Java | Spring Boot | Docker | Oracle Cloud | Vercel | Prometheus | LangChain4j**
